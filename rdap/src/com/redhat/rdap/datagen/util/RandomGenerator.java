package com.redhat.rdap.datagen.util;
...
public final class RandomGenerator {
    ...
    /**
     * @param min
     *            the minimum value the generated number can be
     * @param max
    ...
    /**
     * @param lastPlusOne
     *            the number one greater than the maximum number that can be
     *            generated
     * @return a random <code>int</code> between zero (inclusive) and the input
     *         parameter (exclusive)
     */
    ...
    /**
     * @param elements
     *            a collection of which one element is chosen randomly (cannot
     *            be <code>null</code> or empty)
     * @return a random element from the input collection (never
     *         <code>null</code>)
     */
    ...
    /**
     * @param elements
     *            an array of which one element is chosen randomly (cannot be
    ...
    /**
     * @param elements
     *            an array of enums of which one is chosen randomly (cannot be
     *            <code>null</code> or empty)
    ...
    /**
     * @param firstDate
     *            the first value the generated timestamp can be (cannot be
     *            <code>null</code>)
     * @param lastDate
     *            the last value the generated timestamp can be (cannot be
     *            <code>null</code>)
     * @return a random timestamp value within the specified range (never
     *         <code>null</code>)
     */
     ...
     * @param max
     *            the maximum value the generated number can be
     * @return a random float value within the specified range rounded to 2
     *         decimal digits
     */
